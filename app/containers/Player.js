...
class Player extends Component {
  ...
  renderVideoPlayer() {
    const {selectedVideo, isDownloadPage} = this.props;
    if(this.state.songs[this.state.songIndex] && selectedVideo) {
    return (<Video
              source={{uri: `${Config.VIDEO_SERVER_URL}/${selectedVideo.url}` }}
